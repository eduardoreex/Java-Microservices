...
import jakarta.persistence.*; // Se usar Spring Boot 3
import java.util.Date;
import com.santana.java.back.end.user_api.dto.UserDTO; // Importante para o método convert
...
public class  User {
    ...
    // Método obrigatório para converter o DTO em Entity [cite: 2976-2982]
